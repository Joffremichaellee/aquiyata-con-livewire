        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden sm:rounded-lg">
                <!--<div class="intro-y flex items-center mt-8">
                    <h2 class="text-lg font-medium mr-auto">Editar Empresa</h2>
                </div>-->
                <div clss="grid grid-cols-12 gap-6 mt-5">
                                ...
                                <div class="preview">
                                    <!-- BEGIN: Validation Form -->      
                                        ...
                                        <div class="input-form mt-3">
                                            ...
                                            <input type="file" name="logo" wire:model="logo" id="logo">
                                        ...
                                        <button wire:click="editar({{$empresa->id}})"  class="btn btn-primary rounded-full mt-5">Agregar</button>
