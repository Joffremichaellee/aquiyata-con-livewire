                ...
                <div class="grid md:grid-cols-6 gap-4">
                    <div class="intro-y md:col-start-2 md:col-span-4 ">
                        ...
                        <div class="intro-y box">
                            <div class="flex flex-col sm:flex-row mt-2.5 mr-2.5 items-center p-5 border-b border-gray-200 dark:border-dark-5">
                                <h2 class="font-medium text-base mr-auto">Implementation</h2>
                                <!--<div class="w-full sm:w-auto flex items-center sm:ml-auto flex sm:mt-0">
                            ...
                            <div id="form-validation" class="grid grid-cols-6 py-5 justify-center">
                                    ...
                                    <div class="preview">
                                        <!-- BEGIN: Validation Form -->                                        
                                            ...
                                            <div class="input-form ">
                                                ...
                                                @elseif ($empresa->logo) <!-- tambien solo puede ir else-->
                                                    
                                                    <div class="w-20 h-20 image-fit zoom-in mt-5">
                                                        <img alt="logo" class="tooltip rounded-full" src="{{ ($empresa->logo) }}" title="Uploaded at 23 December 2022">
                                                    </div>
                            ...
                            <div class="card-footer" style="text-align-last: justify;padding:0 25px">
                                ...
                                <button wire:click="editar" wire:loading.attr="disabled" wire:target="editar, image" class="disabled:opacity-25 btn btn-primary rounded-full mt-5">Editar</button>
