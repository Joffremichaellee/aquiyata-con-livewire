<div class="intro-y">
    ...
    <style>
        ...
        @media only screen and (min-width: 320px) and (max-width: 2357px) {
            .descripcion{
                display: -webkit-box;
    ...
    <div
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <a href={{route('empresa.create')}} class="btn btn-primary shadow-md mr-2">Nueva Categoria</a>
                    ...
                    <table class="table table-report -mt-2">
                        <thead>
                            <tr>
                                ...
                                <th wire:click="order('dni_ruc')" class="cursor-pointer whitespace-nowrap">
                                    DNI & RUC
                                ...
                                <th wire:click="order('telefono')" class="cursor-pointer whitespace-nowrap">
                                    TELEFONO
                                ...
                                <th wire:click="order('celular')" class="cursor-pointer whitespace-nowrap">
                                    CELULAR
                                ...
                                <th wire:click="order('email')" class="cursor-pointer whitespace-nowrap">
                                    EMAIL
                                ...
                                <th wire:click="order('whatsapp')" class="cursor-pointer whitespace-nowrap">
                                    WHATSAPP
                                ...
                                <th style="" wire:click="order('estrellas')" class="cursor-pointer whitespace-nowrap">
                                    ESTRELLAS
                        ...
                        <tbody>
                            ...
                            @foreach ($empresas as $emp)
                                <tr class="intro-x">
                                    <td class="w-10">
                                        <div class="flex justify-center">
                                            ...
                                            <div class="w-10 h-10 image-fit zoom-in rounded-full">
                                                <img alt="Tinker Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ $emp->logo }}" title="Uploaded at 23 December 2022">
                                            </div>
                                    ...
                                    <td>
                                        <p href="" class="font-medium whitespace-nowrap">{{ $emp->nombre }}</p>
                                        <!--<div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">Smartphone &amp; Tablet
                            </div>-->
                                    </td>
                                    <td>
                                        <p href="" class="font-medium whitespace-nowrap">{{ $emp->dni_ruc }}</p>
                                        <!--<div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">Smartphone &amp; Tablet
                            </div>-->
                                    </td>
                                    <td>
                                        <p href="" class="font-medium whitespace-nowrap">{{ $emp->telefono }}</p>
                                        <!--<div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">Smartphone &amp; Tablet
                            </div>-->
                                    </td>
                                    <td>
                                        <p href="" class="font-medium whitespace-nowrap">{{ $emp->celular }}</p>
                                        <!--<div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">Smartphone &amp; Tablet
                            </div>-->
                                    </td>
                                    <td>
                                        <p href="" class="font-medium whitespace-nowrap">{{ $emp->email }}</p>
                                        <!--<div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">Smartphone &amp; Tablet
                            </div>-->
                                    </td>
                                    <td>
                                        <p href="" class="font-medium whitespace-nowrap">{{ $emp->whattsap }}</p>
                                        <!--<div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">Smartphone &amp; Tablet
                            </div>-->
                                    </td>
                                    <td>
                                        <p href="" class="flex font-medium whitespace-nowrap justify-center">
                                            @if ($emp->estrellas === "1")
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                                                </svg>
                                            @elseif($emp->estrellas === "2")
                                    ...
                                    <td class="w-40 text-center">
                                        @if ($emp->estado === 1)
                                            <button wire:click="activar({{$emp->id}})"
                                            ...
                                            {{$estado}}
                                        @elseif($emp->estado === 0)
                                            <button wire:click="desactivar({{$emp->id}})"
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            ...
                                            <a href="{{ route('empresa.edit', $emp->id) }}" class="flex items-center mr-3" href="javascript:;"><!--href="javascript:;"-->
                                            ...
                                            <a wire:click="$emit('alertDeleteCategoria', {{$emp}})" class="flex items-center text-theme-6" href="javascript:;"
